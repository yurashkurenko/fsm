...
def dial(update: Update, context: CallbackContext) -> None:
    ...
    answer=dialog.dialog(update.message.text,user_id)
    user_id=update.message.chat.id
    # print(answer)
    InputFieldPlaceholder=answer[3]
...
#    reply_keyboard =eval("[['Boy', 'Girl', 'Other', 'Girl', 'Other', 'Girl', 'Other', #'Girl', 'Other'],['Boy', 'Girl', 'Other']]")
    reply_keyboard =eval(answer[2])
    exec(answer[4])
    #input_field_placeholder='Вы где-то здесь'
